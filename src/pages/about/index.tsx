    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-5xl xl:px-0">
      ...
      <div className="py-6 min-h-[75vh]">
        <p>
          ...
          di Pejuang Pemrograman, kita saling berbagi dan belajar bareng. <br />
          <br />
          Intinya, kita pengen bikin komunitas yang asik buat belajar teknologi.
          Tempat di mana kamu bisa nanya apa aja tanpa takut dibilang noob, dan
          di mana kamu juga bisa pamer dikit kalau berhasil nyelesaiin proyek
          keren. <br />
          <br />
