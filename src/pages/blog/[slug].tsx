              ...
              <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700 px-3 md:px-0">
                <header className="pt-6 xl:pb-6 border-b border-gray-400">
                  <div className="space-y-1 text-center">
                    ...
                    {/* Show ProfileCard only on smaller screens */}
                    <ProfileCard className="flex xl:hidden mt-4" post={post} />
                  </div>
                </header>
              </div>

              {/* Main Content Section */}
              <div className="flex flex-col-reverse xl:flex-row xl:items-start justify-center py-6 md:py-10 mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-5xl xl:px-0 dark:text-white">
                {/* ProfileCard for larger screens */}
                ...
                {/* Markdown content */}
                <div className="prose md:prose-xl md:p-0 max-w-full xl:max-w-[75%] mx-auto xl:mx-0">
